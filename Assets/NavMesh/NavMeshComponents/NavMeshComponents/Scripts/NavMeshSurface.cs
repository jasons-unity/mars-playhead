...
namespace UnityEngine.AI
{
    ...
    public class NavMeshSurface : MonoBehaviour
    {
        ...
        static readonly List<SphereCollider> k_SphereColliders = new List<SphereCollider>();
        static readonly List<BoxCollider> k_BoxColliders = new List<BoxCollider>();
        static readonly List<CapsuleCollider> k_CapsuleColliders = new List<CapsuleCollider>();
