...
namespace Unity.Labs.MARS
{
    ...
    class AutoSyncToggleArgs : EditorEventArgs
    {
        public bool enabled;
    }
    ...
    static class EditorEvents
    {
        ...
        /// <summary>
        /// This event occurs when a user toggles the "AutoSync" option in Simulation Controls
        /// </summary>
        public static MarsEditorEvent<AutoSyncToggleArgs> AutoSyncToggle = new MarsEditorEvent<AutoSyncToggleArgs>(k_UiPrefix, "autoSyncToggle");
