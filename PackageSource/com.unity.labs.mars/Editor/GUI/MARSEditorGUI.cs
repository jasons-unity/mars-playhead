...
namespace Unity.Labs.MARS
{
    ...
    public static class MARSEditorGUI
    {
        ...
        {
            static readonly Vector2 k_PopupSize = new Vector2(280f, 144f);
        ...
        public static void DrawReloadButton(GUIContent content, GUIStyle style, params GUILayoutOption[] options)
        {
            ...
            {
                var simulatingTemporal = QuerySimulationModule.instance.simulatingTemporal;
                var envManager = MARSEnvironmentManager.instance;

                envManager.RefreshEnvironmentAndRestartSimulation(simulatingTemporal);
            }
        }
    }
}
