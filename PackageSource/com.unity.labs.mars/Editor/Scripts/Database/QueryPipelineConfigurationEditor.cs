...
namespace Unity.Labs.MARS
{
    ...
    public class QueryPipelineConfigurationEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var stageInstances = QueryPipelinesModule.instance != null ?
                QueryPipelinesModule.instance.StandalonePipeline.Stages : null;
            ...
            if (m_ShowOrderWeightFoldout)
            {
                EditorGUILayout.Slider(m_ReservedMemberWeightProperty,
                    SetOrderWeights.MinReservedWeight, SetOrderWeights.MaxReservedWeight);
                EditorGUILayout.Slider(m_SharedMemberWeightProperty,
                    SetOrderWeights.MinSharedWeight, SetOrderWeights.MaxSharedWeight);
                EditorGUILayout.Slider(m_RelationWeightProperty,
                    SetOrderWeights.MinRelationWeight, SetOrderWeights.MaxRelationWeight);
            }
