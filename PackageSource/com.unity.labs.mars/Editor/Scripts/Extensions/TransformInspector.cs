...
namespace Unity.Labs.MARS
{
    ...
    class TransformInspector : Editor
    {
        ...
        static MARSUserPreferences s_UserPreferences;
        ...
        public void OnEnable()
        {
            ...
            if (s_UserPreferences == null)
                s_UserPreferences = MARSUserPreferences.instance;
            ...
            m_IsMarsScene = session.gameObject.scene == scene || simSceneModule.ContentScene == scene;
            ...
            if (simSceneModule.IsSimulationReady && m_Transform.gameObject.scene == simSceneModule.ContentScene)
            {
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.DisabledScope(m_IsMarsSession))
            {
            ...
            {
                MARSUtils.HintBox(m_IsMarsScene && s_UserPreferences.showWorldScaleHint, k_WorldScaleHint,
                    k_WorldScaleHintAnalyticsLabel, k_LearnAboutScale, MARSHelpURLs.WorldScaleHelpURL, k_StopShowingHints, () =>
                {
                    s_UserPreferences.showWorldScaleHint = false;
                });
            }

            if (m_SettingHideFlags)
            {
                MARSUtils.HintBox(s_UserPreferences.ShowDisabledSimulationComponentsHint, k_DisabledComponentHint,
                    k_DisableComponentHintAnalyticsLabel, null, MARSHelpURLs.WorldScaleHelpURL, k_StopShowingHints, () =>
                {
                    s_UserPreferences.ShowDisabledSimulationComponentsHint = false;
                });
            }
