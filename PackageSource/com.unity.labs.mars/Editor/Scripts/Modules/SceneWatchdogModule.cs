    ...
    public class SceneWatchdogModule : EditorScriptableSettings<SceneWatchdogModule>, IModuleDependency<SimulatedObjectsManager>
    {
        ...
        void GetCurrentComponents()
        {
            ...
            foreach (var gameObject in k_RootGameObjects)
            {
                ...
                m_CurrentFunctionalitySubscribers.AddRange(k_FunctionalitySubscribers);
            }
        ...
        internal void ScenePoll()
        {
            ...
            foreach (var obj in m_CurrentFunctionalitySubscribers)
            {
                if (obj == null)
                    k_RemovedFunctionalitySubscribers.Add(obj);
                else
                    k_PreviousFunctionalitySubscriberSet.Add(obj);
            }
