    ...
    public class MarsMarkerLibraryEditor : Editor
    {
        ...
        bool DrawMarkerDefinition(int index)
        {
            ...
            using (new EditorGUILayout.HorizontalScope())
            {
                ...
                shouldRemove = GUILayout.Button(styles.removeButtonContent, GUILayout.Width(k_CloseIconSize),
                    GUILayout.Height(k_CloseIconSize), GUILayout.ExpandWidth(false));
            }
            ...
            if (specifySizeProperty.boolValue)
            {
                using (new EditorGUI.IndentLevelScope())
                {
                    ...
                    if (sizeProperty.vector2Value.x <= MarkerConstants.MinimumPhysicalMarkerSizeWidthInMeters ||
                        ...
                        EditorGUILayout.HelpBox(MarkerConditionInspector.styles.minimumMarkerDefinitionDimensionsStr,
                            MessageType.Warning);
                }
            }
