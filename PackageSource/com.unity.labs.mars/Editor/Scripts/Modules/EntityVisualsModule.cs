...
#pragma warning restore 649
        ...
        void UpdateImageMarkerConditionVisuals()
        {
            ...
            var loadedMARSSession = MARSUtils.GetMARSSession(SceneManager.GetActiveScene());
            ...
            foreach (var entityVisualMarkerContitionKeyValuePair in m_ImageMarkerConditions)
            {
                ...
                for (var i = 0; i < loadedMarkerLibrary.Count; i++)
                {
                    ...
                    {
                        entityVisualMarkerContitionKeyValuePair.Key.SetScale(new Vector3(loadedMarkerLibrary[i].Size.x, 0.01f, loadedMarkerLibrary[i].Size.y) * MARSWorldScaleModule.GetWorldScale());
        ...
        void ScalePlaneSizeConditionVisuals()
        {
            ...
            foreach (var kvp in m_SizeConditions)
            {
                ...
                if (planeSizeCondition != null)
                {
                    ...
                    kvp.Key.SetScale(new Vector3(planeSize.x, 1f, planeSize.y) * MARSWorldScaleModule.GetWorldScale());
                }
            }
        }
