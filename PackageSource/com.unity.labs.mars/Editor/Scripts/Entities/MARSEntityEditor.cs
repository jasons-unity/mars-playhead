...
#pragma warning restore 0414
        ...
        MARSUserPreferences m_MARSUserPreferences;
        ...
        public static Action<ComponentInspector> drawAfterComponent { get; set; }
        ...
        public void OnEnable()
        {
            ...
            m_MARSUserPreferences = MARSUserPreferences.instance;
        ...
        void RefreshComponentList()
        {
            ...
            m_ListEditor.afterDrawComponentInspector += CompareToDataModule.DrawAfterComponent;
        ...
        public override void OnInspectorGUI()
        {
            ...
            else
            {
                ...
                CompareToDataModule.DrawControls(this);

                if (m_MARSUserPreferences.showEntitySetupHints)
            ...
            else if ((m_SelectedEntity as ProxyGroup) != null)
            {
                if (m_Relations.Count < 1 && m_MultiRelations.Count < 1)
                {
                    MARSUtils.HintBox(true, k_NoRelationWarning, k_NoRelation,
                        ...
                        () => {
                            m_MARSUserPreferences.showEntitySetupHints = false;
                        });
