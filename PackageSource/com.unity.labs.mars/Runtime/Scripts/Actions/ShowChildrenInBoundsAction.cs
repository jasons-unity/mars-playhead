...
namespace Unity.Labs.MARS
{
    ...
    public class ShowChildrenInBoundsAction : MonoBehaviour, IMatchVisibilityHandler, IUsesMARSTrackableData<MRPlane>, IUsesCameraOffset
    {
        ...
        void IMatchVisibilityHandler.FilterVisibleObjects(QueryState newState, QueryResult queryResult, List<GameObject> objectsToActivate, List<GameObject> objectsToDeactivate)
        {
            switch (newState)
            {
                ...
                case QueryState.Tracking:
                    ...
                    var bounds = mrPlane.extents * 0.5f;
                    ...
                    var pose = this.ApplyOffsetToPose(mrPlane.pose);
