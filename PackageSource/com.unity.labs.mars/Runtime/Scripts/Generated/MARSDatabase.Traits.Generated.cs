...
namespace Unity.Labs.MARS.Data
{
    public partial class MARSDatabase
    {
        ...
        ///<summary>Provides all trait data of type Vector3</summary>
        internal MARSTraitDataProvider<UnityEngine.Vector3> Vector3TraitProvider { get; private set; }
        ...
        void InitializeTraitProviders(Action<int> setDirtyIfNeeded)
        {
            ...
            Vector3TraitProvider = new MARSTraitDataProvider<UnityEngine.Vector3>(setDirtyIfNeeded, this);
            RegisterTraitTypeProvider(Vector3TraitProvider);
        }
        ...
        void UnloadTraits(MARSDatabase self)
        {
            ...
            self.Vector3TraitProvider.Unload();
        }
        ...
        void ClearTraits(MARSDatabase self)
        {
            ...
            self.Vector3TraitProvider.Clear();
        }
        ...
        internal void GetTraitProvider(out MARSTraitDataProvider<UnityEngine.Vector3> provider)
        {
            provider = Vector3TraitProvider;
        }
        ...
        void StartBufferingInternal(MARSDatabase self)
        {
            ...
            Vector3TraitProvider.StartUpdateBuffering();
        }
        ...
        void StopBufferingInternal(MARSDatabase self)
        {
            ...
            Vector3TraitProvider.StopUpdateBuffering();
        }
    }
}
