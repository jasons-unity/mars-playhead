...
namespace Unity.Labs.MARS.Data
{
    partial class CachedTraitCollection
    {
        ...
        ///<summary>All trait values of type Vector3 associated with this context</summary>
        List<Dictionary<int, UnityEngine.Vector3>> Vector3Collections;
        ...
        void ClearInternal(CachedTraitCollection self)
        {
            ...
            if(Vector3Collections != null)
            {
                for(var i = 0; i < Vector3Collections.Count; i++)
                {
                    Vector3Collections[i] = null;
                }
            }
        }
        ...
        void FromConditions(Conditions conditions)
        {
            ...
            var vector3Length = conditions.GetTypeCount(out ICondition<UnityEngine.Vector3>[] vector3Conditions);
            if(vector3Length > 0)
            {
                Vector3Collections = new List<Dictionary<int, UnityEngine.Vector3>>();
                for(var i = 0; i < vector3Length; i++)
                {
                    Vector3Collections.Add(null);
                }
            }
        }
        ...
        bool CheckDestroyedInternal(CachedTraitCollection self)
        {
            ...
            if(Vector3Collections != null)
            {
                foreach(var dictionary in Vector3Collections)
                {
                    if(dictionary == null)
                        return true;
                }
        ...
        public bool TryGetType(out List<Dictionary<int, UnityEngine.Vector3>> traits)
        {
            traits = Vector3Collections;
            return Vector3Collections != null;
        }
    }
}
