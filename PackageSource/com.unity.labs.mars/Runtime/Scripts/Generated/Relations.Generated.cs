...
namespace Unity.Labs.MARS.Query
{
    public partial class Relations
    {
        ...
        ///<summary>All Relations of type Single associated with this context</summary>
        IRelation<System.Single>[] FloatRelations;
        ...
        public bool TryGetType(out IRelation<System.Single>[] relations)
        {
            relations = FloatRelations;
            return relations != null;
        }
        ...
        public int GetTypeCount(out IRelation<System.Single>[] relations)
        {
            return !TryGetType(out relations) ? 0 : relations.Length;
        }
        ...
        public void FromRelation(Relation relation)
        {
            ...
            var floatCondition = relation as IRelation<System.Single>;
            FloatRelations = floatCondition != null ? new[] { floatCondition } : null;
            ...
            where TComponentRootType : Component
        {
            ...
            FloatRelations = componentFilter.GetMatchingComponents<IRelation<System.Single>>();
            Count += FloatRelations.Length;
