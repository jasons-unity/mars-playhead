...
namespace Unity.Labs.MARS.Query
{
    public partial class Conditions
    {
        ...
        ///<summary>All Conditions of type Vector3 associated with this context</summary>
        ICondition<UnityEngine.Vector3>[] Vector3Conditions;
        ...
        public bool TryGetType(out ICondition<UnityEngine.Vector3>[] conditions)
        {
            conditions = Vector3Conditions;
            return conditions != null;
        }
        ...
        ///<summary>Get the number of conditions of type Vector3 associated with this context</summary>
        public int GetTypeCount(out ICondition<UnityEngine.Vector3>[] conditions)
        {
            return !TryGetType(out conditions) ? 0 : conditions.Length;
        }
        ...
        public void FromCondition(Condition condition)
        {
            ...
            var vector3Condition = condition as ICondition<UnityEngine.Vector3>;
            Vector3Conditions = vector3Condition != null ? new[] { vector3Condition } : null;
        }
            ...
            where TComponentRootType : Component
        {
            ...
            Vector3Conditions = componentFilter.GetMatchingComponents<ICondition<UnityEngine.Vector3>>();
        }
        ...
        static int CountInternal(Conditions self)
        {
            ...
            count += self.Vector3Conditions.Length;
            return count;
        }
    }
}
