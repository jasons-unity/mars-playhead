...
namespace Unity.Labs.MARS
{
    ...
    public class PlaneDiscoveryVoxelGrid : PlaneVoxelGrid<MRLayerPlaneData>, IUsesCameraOffset
    {
        ...
        protected override MRLayerPlaneData CreateLayerPlane(PlaneVoxel startingVoxel) { return new MRLayerPlaneData(startingVoxel); }
        ...
        bool TryCreateMRPlane(MRLayerPlaneData layerPlane, Pose layerOriginPose)
        {
            ...
            PlaneUtils.TriangulatePlaneFromVerties(pose, mrPlaneVertices, indices, normals, textureCoordinates);
        ...
        void UpdateMRPlane(MRLayerPlaneData layerPlane, Pose layerOriginPose)
        {
            ...
            PlaneUtils.TriangulatePlaneFromVerties(mrPlane.pose, mrPlaneVertices, indices, normals, textureCoordinates);
