...
#pragma warning restore 67
        ...
        static readonly List<Vector3> k_Normals = new List<Vector3>();
        ...
        void SetupFromEnvironment()
        {
            ...
            m_UpVoxelGrid = new PlaneDiscoveryVoxelGrid(VoxelGridOrientation.Up, sceneBounds, m_VoxelSize, m_PlaneFindingParams);
            m_DownVoxelGrid = new PlaneDiscoveryVoxelGrid(VoxelGridOrientation.Down, sceneBounds, m_VoxelSize, m_PlaneFindingParams);
            m_ForwardVoxelGrid = new PlaneDiscoveryVoxelGrid(VoxelGridOrientation.Forward, sceneBounds, m_VoxelSize, m_PlaneFindingParams);
            m_BackVoxelGrid = new PlaneDiscoveryVoxelGrid(VoxelGridOrientation.Back, sceneBounds, m_VoxelSize, m_PlaneFindingParams);
            m_RightVoxelGrid = new PlaneDiscoveryVoxelGrid(VoxelGridOrientation.Right, sceneBounds, m_VoxelSize, m_PlaneFindingParams);
            m_LeftVoxelGrid = new PlaneDiscoveryVoxelGrid(VoxelGridOrientation.Left, sceneBounds, m_VoxelSize, m_PlaneFindingParams);
        ...
        void OnPointCloudUpdated(Dictionary<MarsTrackableId, PointCloudData> data)
        {
            ...
            var count = 0;
            m_PointCloudProvider.GetNormals(k_Normals);
            foreach (var kvp in data)
            {
                ...
                var pointsCount = k_Normals.Count;
