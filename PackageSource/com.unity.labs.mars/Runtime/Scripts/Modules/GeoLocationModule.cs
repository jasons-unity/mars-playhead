...
namespace Unity.Labs.MARS
{
        ...
        IModuleDependency<MARSDatabase>, IModuleDependency<SlowTaskModule>
    {
        ...
        // default simulated coordinates are @ the San Francisco office
        const float k_DefaultLatitude = 37.7869922f;
        const float k_DefaultLongitude = -122.4033781f;
...
#pragma warning disable 0414
        ...
        public event Action<GeographicCoordinate> onGeoLocationChanged;
#pragma warning restore
        ...
        internal void AddOrUpdateLocationTrait()
        {
            ...
            if (onGeoLocationChanged != null)
                onGeoLocationChanged(m_CurrentLocation);
        }
