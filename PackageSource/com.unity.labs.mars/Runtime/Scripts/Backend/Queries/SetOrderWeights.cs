...
{
    [Serializable]
    public struct SetOrderWeights : IEquatable<SetOrderWeights>
    {
        ...
        public SetOrderWeights(float relation = k_DefaultRelation,
        ...
        public static SetOrderWeights GetDefault()
        {
            return new SetOrderWeights
            {
        ...
        public bool Equals(SetOrderWeights other)
        {
        ...
        {
            return obj is SetOrderWeights other && Equals(other);
        }
        ...
        public static bool operator ==(SetOrderWeights left, SetOrderWeights right)
        {
