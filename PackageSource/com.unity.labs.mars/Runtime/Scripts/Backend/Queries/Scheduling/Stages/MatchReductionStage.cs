...
namespace Unity.Labs.MARS.Query
{
        ...
        List<Dictionary<int, float>>>
    {
        ...
        internal static void ReduceRatings(List<int> indices, List<ConditionRatingsData> rawRatings,
            List<HashSet<int>> matchSets, ref List<Dictionary<int, float>> flatRatings)
        {
