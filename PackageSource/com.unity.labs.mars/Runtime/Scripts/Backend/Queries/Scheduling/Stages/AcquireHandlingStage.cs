...
namespace Unity.Labs.MARS.Query
{
    ...
    class AcquireHandlingTransform : DataTransform<List<QueryResult>, List<Action<QueryResult>>>
    {
#if UNITY_EDITOR
        ...
        void CallHandlers(List<int> indices, List<QueryResult> results,
            ref List<Action<QueryResult>> handlers)
        {
