    ...
    public partial class MARSDatabase
    {
            ...
            Relations relations, SetQueryResult result)
        {
            ...
            foreach (var kvp in dataAssignments)
            {
                ...
                if (!TryUpdateQueryMatchData(dataAssignments[child], args.tryBestMatchArgs.conditions, args.TraitRequirements, childResults[child]))
                {
                    if (args.required)
                        return false;
        ...
        internal bool FindTraitCollections(Relations relations, RelationTraitCache cache)
        {
        ...
        public static bool FindTraitCollections<T>(MARSTraitDataProvider<T> traitProvider,
