...
namespace Unity.Labs.MARS.Data
{
    ...
    public delegate float TryBestMatchConditionsDelegate(TryBestMatchArguments arguments, QueryResult result, out int bestDataID);

    public delegate void MarkDataUsedForUpdatesDelegate(int dataID, QueryMatchID queryMatchID, Exclusivity exclusivity);
    public delegate void UnmarkDataUsedForUpdatesDelegate(QueryMatchID queryMatchID);
    public delegate bool QueryDataDirtyDelegate(QueryMatchID queryMatchID);
    public delegate bool TryUpdateQueryMatchDataDelegate(int dataID, Conditions conditions, ContextTraitRequirements requirements, QueryResult result);

    public delegate bool TryMatchRelationsDelegate(Relations relations,
        SetQueryResult result, ref SetMatchData matchingData);


    public delegate void MarkSetDataUsedForUpdatesDelegate(QueryMatchID queryMatchId, HashSet<int> data);

    public delegate void UnmarkSetDataUsedForUpdatesDelegate(QueryMatchID queryMatchID);
    public delegate void UnmarkPartialSetDataUsedForUpdatesDelegate(QueryMatchID queryMatchID, ICollection<IMRObject> childrenToUnmark);
    public delegate bool IsSetQueryDataDirtyDelegate(QueryMatchID queryMatchID);

    public delegate bool TryUpdateSetQueryMatchDataDelegate(SetMatchData data,
        Relations relations, SetQueryResult result);

    public static class IUsesDatabaseQueryingMethods
    {
    ...
    public static class IUsesDatabaseQueryingExtensionMethods
    {
        ...
        public static bool TryUpdateQueryMatchData(this IUsesDatabaseQuerying obj, int dataID, Conditions conditions, ContextTraitRequirements requirements, QueryResult result)
        {
