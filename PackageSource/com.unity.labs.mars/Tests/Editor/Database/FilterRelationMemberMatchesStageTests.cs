...
namespace Unity.Labs.MARS.Data.Tests
{
    public class FilterRelationMemberMatchesStageTests
    {
        ...
        List<Dictionary<int, float>> m_GlobalMemberRatings = new List<Dictionary<int, float>>();

        List<RelationMembership[]> m_AllRelationMemberships;
        ...
        public void Setup()
        {
            ...
            m_AllRelationMemberships = new List<RelationMembership[]>()
            {
        ...
        public void BeforeEach()
        {
            ...
            m_GlobalMemberRatings = new List<Dictionary<int, float>>
            {
