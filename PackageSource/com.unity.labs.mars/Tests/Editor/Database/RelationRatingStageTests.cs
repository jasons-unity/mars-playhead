...
#pragma warning restore 649
        ...
        public void TryMatchRelationType()
        {
            ...
            var memberRatingsList = new List<Dictionary<int, float>>(2)
            {
        ...
        public void TryMatchAll()
        {
            ...
            var memberRatingsList = RandomRatingsList(relations.children.Count);
            ...
            Assert.False(RelationRatingTransform.TryMatchAll(relations, traitCache, relationRatings,
                memberRatingsList, relationIndexPairs));
        ...
        static List<Dictionary<int, float>> RandomRatingsList(int count)
        {
            var list = new List<Dictionary<int, float>>(count);
            for (var i = 0; i < count; i++)
            {
                list.Add(TestUtils.RandomRatings());
            }
