...
namespace Unity.Labs.MARS.Data.Tests
{
    ...
    static class DatabaseTestData
    {
        ...
        internal static readonly List<Dictionary<int, float>> RatingSetOne = new List<Dictionary<int, float>>
        {
        ...
        internal static readonly List<Dictionary<int, float>> RatingSetTwo = new List<Dictionary<int, float>>
        {
            null,
