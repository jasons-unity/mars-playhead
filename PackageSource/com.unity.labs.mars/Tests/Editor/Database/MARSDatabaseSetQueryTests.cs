...
namespace Unity.Labs.MARS.Data.Tests
{
    public class MARSDatabaseSetQueryTests
    {
        ...
        MARSDatabase m_Db;
        SetQueryPipeline m_SetPipeline;
        ...
        public void SetupBeforeEach()
        {
            ...
            m_SetPipeline = new SetQueryPipeline(m_Db);
            m_SetPipeline.SetupData();
        ...
        {
            QueryPipelinesModule.instance.SetPipeline = m_SetPipeline;
            m_SetPipeline.Register(id, args);

            if (expectedMatches == null)
                return;

            var memberCount = 0;
            var setIndex = m_SetPipeline.Data.MatchIdToIndex[id];
            var memberIndices = m_SetPipeline.Data.MemberIndices[setIndex];
            ...
            foreach (var child in expectedMatches)
            {
                ...
                m_SetPipeline.MemberData.BestMatchDataIds[memberIndex] = matchInfo.dataID;
                memberCount++;
            }
        }
