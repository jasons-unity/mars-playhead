...
namespace Unity.Labs.MARS.Data.Tests
{
    public class MARSDatabaseQueryTests
    {
        ...
        ContextTraitRequirements m_TraitRequirements = new ContextTraitRequirements(new List<TraitRequirement>()
        {
        ...
        ContextTraitRequirements m_EmptyTraitRequirements = new ContextTraitRequirements(new List<TraitRequirement>());
        ...
        public void QueryDataDirty_DataNotMarkedAsUsedAndDataChanged_ReturnsFalse()
        {
            ...
            Assert.False(m_Db.QueryDataDirty(m_QueryMatchId));
        }
