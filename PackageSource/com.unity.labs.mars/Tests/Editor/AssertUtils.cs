...
namespace MARS.Tests.Editor
{
    static class AssertUtils
    {
        ...
        internal static void MatchRatingsValid(IEnumerable<float> ratings)
        {
            foreach (var rating in ratings)
            {
                MatchRatingValid(rating);
            }
        }
        ...
        internal static void CollectionsInitialized<T>(this IEnumerable<T> items)
            where T: class
        {
