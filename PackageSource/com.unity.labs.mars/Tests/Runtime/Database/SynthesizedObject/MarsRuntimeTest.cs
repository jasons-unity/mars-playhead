...
#pragma warning restore 67
            ...
            void IFunctionalityProvider.ConnectSubscriber(object obj)
            {
                ...
                var cameraProjectionSubscriber = obj as IUsesCameraProjectionMatrix;
        ...
        internal MARSSession m_MARSSession;
        ...
        protected void ForceUpdateQueries()
        {
            m_QueryBackend.RunAllQueries();
        }
