...
{
    public class EditorWindowContext : EditorHandleContext
    {
        ...
        internal void OnGUI(EditorWindow window, Rect rect, Event evt)
        {
            ...
            switch (evt.GetTypeForControl(id))
            {
                ...
                case EventType.MouseMove:
                    ...
                    { 
                        m_State.Update(UnityEngine.PrefabHandles.HandleUtility.ProjectScreenPositionOnHandle(
                ...
                case EventType.MouseDown:
                    ...
                    if (m_State.StartDrag(UnityEngine.PrefabHandles.HandleUtility.ProjectScreenPositionOnHandle(
                        m_State.activeHandle,
                        GetMousePosition(evt, rect),
                        camera)))
                    {
