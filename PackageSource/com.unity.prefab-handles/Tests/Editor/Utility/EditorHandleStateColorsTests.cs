...
namespace UnityEditor.PrefabHandles.Tests
{
    sealed class EditorHandleStateColorsTests
    {
        ...
        {
            Assert.That(m_EditorContextStateColors.hoverColor, Is.EqualTo(Handles.preselectionColor));
        }

        [Test]
        public void EditorContext_DragColor_IsLinkedToPreference()
        {
            Assert.That(m_EditorContextStateColors.dragColor, Is.EqualTo(Handles.selectedColor));
        }
