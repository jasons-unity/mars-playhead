...
{
    public sealed class DummyHandleTemplate : IDisposable
    {
        ...
        public void Dispose()
        {
            Object.DestroyImmediate(m_Template.gameObject);
        }
        ...
        static InteractiveHandle CreateBasicTemplate()
        {
            ...
            template.AddComponent<MeshRenderer>().material = new Material(Shader.Find("Unity/Handles/UnlitColor"));
